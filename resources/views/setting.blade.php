        ...
        <div class="main-wrapper">
            <div class="settings-section">
                ...
                <div class="card settings-card">
                    <div class="card-header">
                        <h5>Departments</h5>
                        <button class="btn btn-primary" onclick="$('#departmentModal').modal('show');">Add Department</button>
        ...
        <div class="modal-content">
            <form action="{{ route('settings.storeCategory') }}" method="POST">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" onclick="$('#categoryModal').modal('hide');">Close</button>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ route('settings.storeRole') }}" method="POST">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" onclick="$('#roleModal').modal('hide');">Close</button>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ route('settings.storeDepartment') }}" method="POST">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" onclick="$('#departmentModal').modal('hide');">Close</button>
                    {{-- <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button> --}}
